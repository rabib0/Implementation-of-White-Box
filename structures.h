...
void MixColumns(unsigned char * state) {
    unsigned char tmp[0r_16];
    unsigned char tbox[16];
    for (int i = 0; i < 16; i++) {
        tbox[i]=add_temp[i]+sub_temp[i];
	...
	tmp[0] = (unsigned char) mul2[tbox[0]] ^ mul3[tbox[1]] ^ tbox[2] ^ tbox[3];
	tmp[1] = (unsigned char) tbox[0] ^ mul2[state[1]] ^ mul3[state[2]] ^ state[3];
	tmp[2] = (unsigned char) tbox[0] ^ tbox[1] ^ mul2[tbox[2]] ^ mul3[tbox[3]];
	tmp[3] = (unsigned char) mul3[tbox[0]] ^ tbox[1] ^ tbox[2] ^ mul2[tbox[3]];

	tmp[4] = (unsigned char)mul2[tbox[4]] ^ mul3[tbox[5]] ^ tbox[6] ^ tbox[7];
	tmp[5] = (unsigned char)tbox[4] ^ mul2[tbox[5]] ^ mul3[tbox[6]] ^ tbox[7];
	tmp[6] = (unsigned char)tbox[4] ^ tbox[5] ^ mul2[tbox[6]] ^ mul3[tbox[7]];
	tmp[7] = (unsigned char)mul3[tbox[4]] ^ tbox[5] ^ tbox[6] ^ mul2[tbox[7]];

	tmp[8] = (unsigned char)mul2[tbox[8]] ^ mul3[tbox[9]] ^ tbox[10] ^ tbox[11];
	tmp[9] = (unsigned char)tbox[8] ^ mul2[tbox[9]] ^ mul3[tbox[10]] ^ tbox[11];
	tmp[10] = (unsigned char)tbox[8] ^ tbox[9] ^ mul2[tbox[10]] ^ mul3[tbox[11]];
	tmp[11] = (unsigned char)mul3[tbox[8]] ^ tbox[9] ^ tbox[10] ^ mul2[tbox[11]];

	tmp[12] = (unsigned char)mul2[tbox[12]] ^ mul3[tbox[13]] ^ tbox[14] ^ tbox[15];
	tmp[13] = (unsigned char)tbox[12] ^ mul2[tbox[13]] ^ mul3[tbox[14]] ^ tbox[15];
	tmp[14] = (unsigned char)tbox[12] ^ tbox[13] ^ mul2[tbox[14]] ^ mul3[tbox[15]];
	tmp[15] = (unsigned char)mul3[tbox[12]] ^ tbox[13] ^ tbox[14] ^ mul2[tbox[15]];
